<?php
include 'header.php';
include "action/library_cat.php";
?>
            ...
            <div class="page-title-content">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"> مكتبة صــــيب </li>
                    </ol>
                </nav>
...
while ($rows= $result->fetch_assoc()) {
    ?>
                ...
                <div class="entry col-lg-3 col-md-4 col-sm-6 col-12">
                    <a href="library-detail.php?cat=<?php echo $rows["lib_cat_id"]; ?> ">
                        <div class="library-cat-item">
                            <div class="entry-image library-cat-image">
                                <i class="bi bi-folder-fill library-cat-folder"></i>
                            </div>

                            <div class="entry-title text-center  library-cat-name">
                                <h2> <?php echo $rows["lib_cat_name"]; ?> </h2>
                            </div>
                ...
                <!-- <div class="entry col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="grid-inner">
                        <div class="entry-image">
                            <img src="images/library.png" alt="Standard Post with Image">
                        </div>


                        <a href="#" class="button button-rounded button-reveal button-large width96  tleft"><span>
                                تحميل</span><i class="uil uil-file-download"></i></a>
                        <div class="entry-title text-center ">
                            <h2>نموذج اجازة مرضية</h2>
                        </div>
                    </div>
                </div> -->
