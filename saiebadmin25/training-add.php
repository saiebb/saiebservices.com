...
?>
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title"> اضـــف تدريب</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                ...
                                <form method="post" action="action/training_save.php" name="form" id="form"
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a class="btn btn-default  float-right" href="training.php">الغـــــــاء</a>
                                    </div>
                                </form>
                            </div>
