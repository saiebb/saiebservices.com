...
?>
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title"> تعديل رأي عميل</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                ...
                <form method="post" action="action/clientsoponions_update.php" name="form" id="form" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="ar_position"  value="<?php echo $rows['ar_position'] ?>">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="ar_text"> <?php echo $rows['ar_text'] ?> </textarea>
                  ...
                  <div class="card-footer">
                    ...
                    <a class="btn btn-default  float-right" href="clientsoponions.php">الغـــــــاء</a>
                  </div>
                </form>
              </div>
