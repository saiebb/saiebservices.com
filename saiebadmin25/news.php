...
<?php include "action/news_list.php";?>
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6 text-right">
                    <h1 class="m-0">انجازتنا</h1>
                </div><!-- /.col -->
                <div class="col-sm-6   ">
                    <a href="news-add.php" class="btn btn-primary">اضــف</a>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
    ...
    ?>
        ...
        ?>
                                        ...
                                        <td>
                                            ...
                                            <a href="news-edit.php?item=<?php echo $rows['ar_id']; ?>"
