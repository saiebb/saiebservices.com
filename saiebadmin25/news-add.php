...
?>
              ...
              <div class="card card-primary">
                ...
                <form method="post" action="action/news_save.php" name="form" id="form" enctype="multipart/form-data">
                  ...
                  <div class="form-group" >
                    ...
                    <select  name="ar_blog_type" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                      ...
                      <option  value="1">تدريب</option> 
                      <option  value="2">خدمات اعمال </option>
                      <option  value="3">خدمات افراد ومستشفيات</option> 
                      <option  value="6">استشارات مالية</option> 
                    </select>
                  </div>
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">التاريخ</label>
                        ...
                        <input type="date" class="form-control " name="ar_date"/>
