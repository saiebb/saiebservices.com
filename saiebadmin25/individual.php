...
<?php include "action/individual-service_list.php";?>
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6 text-right">
                    <h1 class="m-0"> خدمات الافرد والمنشـــآت</h1>
                </div><!-- /.col -->
                <div class="col-sm-6   ">
                    <a href="individual-add.php" class="btn btn-primary">اضــف</a>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
    ...
    ?>
        ...
        ?>
                                        ...
                                        <td>
                                            ...
                                            <a href="individual-edit.php?item=<?php echo $rows['ar_id']; ?>"
...
function deletItem(itemId) {
    ...
    if (confirm("هل انت متأكد من انك تريد حذف هذا العنصـــر") == true) {
        window.location.href = "action/individual-service_delete.php?item=" + itemId
    }
}
</script>