...
<?php include "action/financial_list.php";?>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6  text-right ">
            <h1 class="m-0"> الاستشــارات المالية</h1>
          </div><!-- /.col -->
          <div class="col-sm-6 ">
          <a href="financial-add.php"  class="btn btn-primary">اضــف</a>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
...
<?php if ($rows["ar_status"] == 1) {
        ?>
                    ...
                    <a href="financial-edit.php?item=<?php echo $rows['ar_id']; ?>" class="btn btn-warning"><i class="fa fa-file" aria-hidden="true"></i></a>
...
function deletItem(itemId) {
  ...
  if (confirm("هل انت متأكد من انك تريد حذف هذا العنصـــر") == true) {
   window.location.href="action/financial_delete.php?item="+itemId
  }
}
</script>
