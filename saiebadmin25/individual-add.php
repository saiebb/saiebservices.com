...
?>
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">  اضــف خدمة أفراد ومنشــآت</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                ...
                                <form method="post" action="action/individual-service_save.php" name="form" id="form"
                                    enctype="multipart/form-data">


                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">القســم</label>
...
while ($rows = $reult->fetch_assoc()) {
    ?>
                      <option  value="<?php echo $rows['ar_cat_id']; ?>"><?php echo $rows["ar_cat_name"]; ?></option>
                      <?php
}?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control " id="ar_price" name="ar_price"
                                                placeholder="أرقــــام صــــحيحة فقــط" />
                                        </div>
                                        <div class="form-group">
