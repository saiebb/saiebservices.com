...
<?php include "action/buinsess-service_by_id.php";?>
...
?>
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title"> تعديل خدمة الأعمال</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                ...
                <form method="post" action="action/buinsess-service_update.php" name="form" id="form" enctype="multipart/form-data">
                  ...
                  <option  value="1"  <?php if ($rows["ar_status"] == 1) {?> selected <?php }?>>نشــط</option>
                    <option  value="2" <?php if ($rows["ar_status"] == 2) {?> selected <?php }?>>غيرنشــط</option>
